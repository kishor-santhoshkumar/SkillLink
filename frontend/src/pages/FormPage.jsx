      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-slate-600">
            Fill out a simple form to create your profile
          </p>
        </div>

        <div className="bg-white rounded-2xl shadow-lg p-8">
          <p className="text-slate-600 mb-6">
            This is the easy form page. A structured form for rural-friendly input will be created here.
          </p>
          
          {/* Placeholder for future structured form */}
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 text-center">
            <p className="text-[#1F3A5F] font-semibold">
              Structured form with dropdowns and checkboxes will be placed here
            </p>
            <p className="text-slate-600 text-sm mt-2">
              (Step-by-step form for semi-literate users)
            </p>
          </div>
        </div>
      </div>
